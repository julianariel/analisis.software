...
public class Metodo {
	...
	public double getHalsteadNivelDificultad() {
		return halsteadNivelDificultad;
	}

	public double getHalsteadNivelPrograma() {
	...
	// Fan out: Cantidad de veces que una funcion es llamada
